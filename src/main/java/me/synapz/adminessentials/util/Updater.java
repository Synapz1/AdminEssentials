...
public class Updater {
    ...
    public Updater(Plugin plugin, int id, File file, UpdateType type, UpdateCallback callback, boolean announce) {
        ...
        if (!Config.getInstance().canUpdate()) {
            this.plugin.getLogger().log(Level.INFO, "AdminEssentials auto update feature disabled. Not checking for updates. To enable it please go to AdminEssentials/config.yml and set auto-update to true");
            return;
        }
